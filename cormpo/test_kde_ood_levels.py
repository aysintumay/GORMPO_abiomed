...
def evaluate_ood_at_distance(model, dataset_name, distance, base_path='/abiomed/downsampled/ood_test', device='cpu'):
    """
...
def main():
    ...
    if args.save_dir is None:
        args.save_dir = 'figures/kde_ood_distance_tests'
