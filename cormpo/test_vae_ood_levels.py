...
def save_results_to_json(all_results, save_dir='figures/vae_ood_distance_tests', model_threshold=None):
    """
...
def main():
    ...
    parser.add_argument('--distances', type=parse_number, nargs='+', default=[0.5, 1, 2, 4, 8],
    ...
    model_dict = VAE.load_model(args.model_path, hidden_dims=[256, 256])
