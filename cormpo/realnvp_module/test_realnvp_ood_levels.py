...
from cormpo.realnvp_module.realnvp import load_rl_data_for_kde, RealNVP
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='figures/realnvp',
    ...
    # Use correct hidden_dims
    hidden_dims = [256, 256]  # Match training config

    model_dict = RealNVP.load_model(args.model_path, hidden_dims=hidden_dims)
